...
class DbAssetTemp extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('db_asset_temp', function (Blueprint $table) {
            $table->bigIncrements('asset_temp_id');
    ...
    {
        //
        Schema::dropIfExists('db_asset_temp');
    }
}
